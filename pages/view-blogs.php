    ...
    <div class="container-fluid py-4 main-wrap">
      <div class="row">
        ...
        <div class="col-6 text-end">
          <a href="./add-blog.php" class="btn btn-info">Add new blog</a>
        </div>
      </div>
      <div class="row">
        
        
      <?php if(mysqli_num_rows($check) > 0){ while($result = mysqli_fetch_assoc($check)){  ?> 
        ...
        <div class="col-lg-6 col-xl-4">
          <div class="card mb-4" style="height: 600px;">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="blog-img p-3" style="height: 300px;">
                <img class="w-100 h-100" style="object-fit: cover;" src=<?php echo $result['image'] ?> alt="" srcset="">
              </div>
